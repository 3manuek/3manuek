---
title: "Overhead estimado de postgres_fdw"
subtitle: "¿Cuánto overhead se agrega usando postgres_fdw Foreign Data Wrappers?"
excerpt: ""
date: 2017-03-06
author: "3manuek"
draft: false
...
como {1} o usando una tabla de catálogo como {2} (_NOTA: los ejemplos siguientes usan código pseudo_).

{{< tabs tabTotal="2">}}
{{% tab tabName="Determinísticamente"%}}
```sql
...
{{% tab tabName="Técnica de tabla de catálogo" %}}
```sql
